var RoomOption;
(function (RoomOption) {
    RoomOption["TrapRoom"] = "Trampa";
    RoomOption["MonsterRoom"] = "Monstruo";
    RoomOption["EmptyRoom"] = "Vac\u00EDa";
...
class Dungeon {
    toString() {
        let description = `Nivel de dificultad mínimo: ${this.minLevel}\n` +
...
function generateDungeonInfo(dungeon) {
